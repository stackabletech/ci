...
# build Docker image
docker build docker/operator-test-runner/ -t docker.stackable.tech/operator-test-runner:latest
...
# build Docker image
docker build docker/jenkins-job-builder/ -t docker.stackable.tech/jenkins-job-builder:latest
