...
if __name__ == "__main__":
    ...
    if(len(sys.argv) < 2 or sys.argv[1] not in ['create-testsuite', 'create-docs-testsuite', 'create-jenkins-jobs', 'create-platform-test-job', 'create-platform-testsuite']):
        print("Please supply command [create-testsuite, create-docs-testsuite, create-jenkins-jobs, create-platform-test-job, create-platform-testsuite]")
        exit(1)

    if("create-testsuite"==sys.argv[1]):
        create_testsuite.create_testsuite()

    if("create-docs-testsuite"==sys.argv[1]):
        create_documentation_testsuite.create_testsuite()
